...
async function getMovieDetails(id: string) {
  ...
  const cleanId = String(id || '').replace(/^(tv-|series-|movie-)/, '');
  ...
  if (!data || !data.movie) {
    return (
      <main className="min-h-screen bg-[#05070b] text-slate-100 flex flex-col items-center justify-center p-6 text-center">
        <h1 className="text-2xl font-bold mb-2">Movie Intelligence Telemetry Not Available</h1>
        ...
        <div className="space-y-3 pt-2 text-xs sm:text-sm">
          <div className="bg-black/40 border border-white/5 rounded-2xl p-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              With a score of {dna.complexity.score}/100, the narrative utilizes non-linear thematic layering and requires active audience engagement.
            </p>
          </div>
          ...
          <div className="bg-black/40 border border-white/5 rounded-2xl p-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Boredom risk ({boredomRisk}) is calculated by evaluating scene transition frequencies and pacing acceleration across the {movie.runtime || 110}-minute runtime.
            </p>
          </div>
          ...
          <div className="bg-black/40 border border-white/5 rounded-2xl p-4">
            ...
            <p className="text-slate-400 leading-relaxed">
              Yes. Our catalog sync checks availability across Prime Video, Netflix, Max, and Apple TV.
            </p>
          </div>
        </div>
      </section>
