...
import { Dices, Sparkles, Star, Loader2, Play, Info, RotateCcw } from "lucide-react";
...
export default function RoulettePage() {
  ...
  const spinTheWheel = async () => {
    ...
    try {
      ...
      // Simulate dramatic 1.5s spinning latency
      setTimeout(() => {
  ...
  return (
    <main className="min-h-screen bg-[#05070b] text-slate-100 px-4 sm:px-8 py-14 flex flex-col items-center selection:bg-indigo-600 selection:text-white relative overflow-hidden">
      ...
      <div className="max-w-3xl w-full text-center z-10">
        ...
        {selectedMovie && !spinning && (
          <div className="bg-gradient-to-b from-[#0e1422] to-[#070a10] border border-indigo-500/30 rounded-3xl p-6 sm:p-8 text-left shadow-2xl animate-fadeIn">
